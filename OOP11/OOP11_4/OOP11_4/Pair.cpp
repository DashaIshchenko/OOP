...
Pair& Pair::operator/=(const double t) {
	this->first = this->first / t;
	this->second = (round((double)(this->second / t) * 100) / 100);
	return *this;
}


Pair& Pair::operator +(const Pair& t) {
	this->first = this->first + t.first;
	this->second = (round((double)(this->second + t.second) * 100) / 100);
	return *this;
}
